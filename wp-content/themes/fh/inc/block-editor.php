...
function generate_enqueue_backend_block_editor_assets() {
	...
	wp_enqueue_style( 'generate-block-editor-bootstrap', get_template_directory_uri() . '/assets/css/bootstrap.css', false, GENERATE_VERSION, 'all' );
	wp_enqueue_style( 'generate-block-editor-styles', get_template_directory_uri() . '/assets/css/custom.css', false, GENERATE_VERSION, 'all' );
