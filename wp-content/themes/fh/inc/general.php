...
if ( ! function_exists( 'generate_scripts' ) ) {
	...
	function generate_scripts() {
		...
		wp_enqueue_script( 'select2', $dir_uri . "/assets/js/select2/select2.js", array(), GENERATE_VERSION, true );
		wp_enqueue_script( 'slidein', $dir_uri . "/assets/js/slidein/slideIn.min.js", array('jquery'), GENERATE_VERSION, true );
		wp_enqueue_script( 'parallax', $dir_uri . "/assets/js/parallax/parallax.js", array('jquery'), GENERATE_VERSION, true );
		wp_enqueue_script( 'custom-scripts', $dir_uri . "/assets/js/custom.js", array(), GENERATE_VERSION, true );
