...
export default function Edit(props) {
	const { setAttributes, attributes: {
		title, content, contentLink, contentLinkText, backgroundImage, colorVariant, fontSize, isFormShortCodeChecked, hideOnMobile, hideOnDesktop, formShortCode
	} } = props;
	...
	return (
		<section {...blockProps} className={`${blockProps.className} ${colorVariant} cta-banner-black-section`}>
					...
					<div className="row cta-banner__content">
						<div className="col-sm-12 col-lg-8 col-xl-7 cta-banner__content-col">
							<div className="cta-banner__content-col--item">
								...
								<RichText
									tagName="p"
									className={`cta-banner__text ${fontSizeClass}`}
									value={content}
									allowedFormats={['core/bold', 'core/italic']}
