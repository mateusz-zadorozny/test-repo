...
//        add_filter('fluentform_notifying_async_mailster', '__return_false');

        $this->logo = $this->app->url('public/img/integrations/mailster.png');
    ...
    public function notify($feed, $formData, $entry, $form)
    {
        ...
        if (function_exists('mailster')) {
            ...
            do_action('ff_integration_action_result', $feed, 'failed', 'Please install or active Mailster plugin.');
        }
    }
