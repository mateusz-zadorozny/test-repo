...
function print_section_info_google_analytics_dashboard()
{
    ...
    <div class="seopress-notice">
        <p><?php printf(__('No stats in the <strong>dashboard widget?</strong> Make sure to have activated these 3 Google APIs from Google Console: <span class="seopress-help dashicons dashicons-external"></span><a href="%1$s" target="_blank"><strong>Google Analytics API</strong></a>, <span class="seopress-help dashicons dashicons-external"></span><a href="%3$s" target="_blank"><strong>Google Analytics Data API</strong></a>, and <span class="seopress-help dashicons dashicons-external"></span><a href="%2$s" target="_blank"><strong>Google Analytics Reporting API</strong></a>.', 'wp-seopress-pro'), esc_url($docs['analytics']['api']['analytics']), esc_url($docs['analytics']['api']['reporting']), esc_url($docs['analytics']['api']['data'])); ?>
        </p>
