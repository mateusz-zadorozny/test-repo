...
function seopress_xml_sitemap_index_xsl() {
	...
	* {
	...
	$seopress_sitemaps_xsl .='<p>'.sprintf(__('This XML Sitemap contains %s videos.','wp-seopress-pro'),'<xsl:value-of select="count(sitemap:urlset/sitemap:url/video:video)"/>').'</p>';
