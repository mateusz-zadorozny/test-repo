 ...
 *
 */
class MediaTitle extends \PYS_PRO_GLOBAL\FacebookAds\Object\AbstractCrudObject
{
    /**
    ...
    {
        return \PYS_PRO_GLOBAL\FacebookAds\Object\Fields\MediaTitleFields::getInstance();
    }
    protected static function getReferencedEnums()
    {
        $ref_enums = array();
        $ref_enums['ContentCategory'] = \PYS_PRO_GLOBAL\FacebookAds\Object\Values\MediaTitleContentCategoryValues::getInstance()->getValues();
        return $ref_enums;
    }
    ...
    {
        $this->assureId();
        $param_types = array('applinks' => 'Object', 'content_category' => 'mediatitle_content_category', 'currency' => 'string', 'description' => 'string', 'fb_page_id' => 'string', 'genres' => 'list<string>', 'images' => 'list<Object>', 'kg_fb_id' => 'string', 'price' => 'unsigned int', 'title' => 'string', 'title_display_name' => 'string', 'url' => 'string');
        $enums = array();
