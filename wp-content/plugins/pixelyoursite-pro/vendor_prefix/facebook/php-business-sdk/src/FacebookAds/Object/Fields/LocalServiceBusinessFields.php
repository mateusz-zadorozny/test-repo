...
class LocalServiceBusinessFields extends \PYS_PRO_GLOBAL\FacebookAds\Enum\AbstractEnum
{
    ...
    {
        return array('address' => 'Object', 'applinks' => 'CatalogItemAppLinks', 'availability' => 'Availability', 'brand' => 'string', 'category' => 'string', 'category_specific_fields' => 'CatalogSubVerticalList', 'condition' => 'Condition', 'cuisine_type' => 'string', 'currency' => 'string', 'custom_label_0' => 'string', 'custom_label_1' => 'string', 'custom_label_2' => 'string', 'custom_label_3' => 'string', 'custom_label_4' => 'string', 'custom_number_0' => 'unsigned int', 'custom_number_1' => 'unsigned int', 'custom_number_2' => 'unsigned int', 'custom_number_3' => 'unsigned int', 'custom_number_4' => 'unsigned int', 'description' => 'string', 'expiration_date' => 'string', 'gtin' => 'string', 'id' => 'string', 'image_fetch_status' => 'ImageFetchStatus', 'images' => 'list<string>', 'local_service_business_id' => 'string', 'phone' => 'string', 'price' => 'string', 'price_range' => 'string', 'retailer_category' => 'string', 'sanitized_images' => 'list<string>', 'size' => 'string', 'title' => 'string', 'unit_price' => 'Object', 'url' => 'string', 'vendor_id' => 'string');
    }
}
