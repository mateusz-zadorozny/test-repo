 ...
 *
 */
class CreditCardFields extends \PYS_PRO_GLOBAL\FacebookAds\Enum\AbstractEnum
{
    ...
    {
        return array('billing_address' => 'Object', 'card_cobadging' => 'string', 'card_holder_name' => 'string', 'card_type' => 'string', 'credential_id' => 'int', 'default_receiving_method_products' => 'list<string>', 'expiry_month' => 'string', 'expiry_year' => 'string', 'id' => 'string', 'is_cvv_tricky_bin' => 'bool', 'is_enabled' => 'bool', 'is_last_used' => 'bool', 'is_network_tokenized_in_india' => 'bool', 'is_soft_disabled' => 'bool', 'is_user_verified' => 'bool', 'is_zip_verified' => 'bool', 'last4' => 'string', 'readable_card_type' => 'string', 'time_created' => 'datetime', 'time_created_ts' => 'int', 'type' => 'string');
    }
}
