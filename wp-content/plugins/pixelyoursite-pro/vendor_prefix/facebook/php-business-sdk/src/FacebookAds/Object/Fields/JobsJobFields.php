...
class JobsJobFields extends \PYS_PRO_GLOBAL\FacebookAds\Enum\AbstractEnum
{
    ...
    {
        return array('address' => 'Object', 'applinks' => 'CatalogItemAppLinks', 'category_specific_fields' => 'CatalogSubVerticalList', 'custom_label_0' => 'string', 'custom_label_1' => 'string', 'custom_label_2' => 'string', 'custom_label_3' => 'string', 'custom_label_4' => 'string', 'custom_label_5' => 'string', 'custom_label_6' => 'string', 'custom_number_0' => 'unsigned int', 'custom_number_1' => 'unsigned int', 'custom_number_2' => 'unsigned int', 'custom_number_3' => 'unsigned int', 'custom_number_4' => 'unsigned int', 'custom_number_5' => 'unsigned int', 'custom_number_6' => 'unsigned int', 'id' => 'string', 'image_fetch_status' => 'ImageFetchStatus', 'images' => 'list<string>', 'jobs_job_id' => 'string', 'sanitized_images' => 'list<string>', 'unit_price' => 'Object', 'url' => 'string');
    }
}
