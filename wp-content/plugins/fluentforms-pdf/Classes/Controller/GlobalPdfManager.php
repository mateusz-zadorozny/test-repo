...
class GlobalPdfManager
{
    ...
    protected function registerHooks()
    {
      //  $this->cleanupTempDir();
        ...
        add_filter('ff_pdf_body_parse', function($content, $entryId, $formData, $form){
        ...
        add_filter('fluentform_all_editor_shortcodes', [$this, 'pushShortCode'], 10, 2);
        add_filter(
            'fluentform_shortcode_parser_callback_pdf.download_link', 
            [$this, 'createLink'],
            10, 
            2
        );
